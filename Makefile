...
RABBITMQ_UPSTREAM_FETCH_URL ?= https://github.com/rdnn/$(RABBITMQ_COMPONENT_REPO_NAME).git
RABBITMQ_UPSTREAM_PUSH_URL ?= git@github.com:rdnn/$(RABBITMQ_COMPONENT_REPO_NAME).git
